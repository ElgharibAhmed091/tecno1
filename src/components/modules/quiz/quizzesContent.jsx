...
export default function QuizContentForm({ item, submit, deleted,disabled }) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={handleSubmit(submit)} className="space-y-6 p-4 border rounded-lg shadow-md" disabled={disabled}>
        {/* Quiz Title Field */}
        <FormField
