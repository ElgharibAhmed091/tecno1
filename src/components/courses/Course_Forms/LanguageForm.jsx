...
export const LanguageForm = ({ initialData, courseId,setInitial }) => {
        ...
        <div className="mt-6 border bg-slate-100 rounded-md p-4">
            <div className="font-medium flex items-center justify-between">
                ...
                <Button onClick={toggleEdit} variant='ghost'>
                    {isEditing ? "Cancel" : <>
                        <Pencil className="h-4 w-4 mr-2"/> Edit language
                    </>}
                </Button>
            </div>
            {!isEditing && (<p className="text-sm mt-2">{initialData.language}</p>)}
